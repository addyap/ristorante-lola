// Photos live in /public/photos. Alt text uses the dish's Italian name,
// which is authentic across every language.
export const gallery: { src: string; alt: string }[] = [
  { src: "/photos/02-bistecca-fiorentina-alla-brace.jpg", alt: "Bistecca fiorentina alla brace" },
